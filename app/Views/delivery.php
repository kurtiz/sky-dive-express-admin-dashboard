        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Inventory</span></h4>
                    <div class="row">
                            ...
                            <div class="card-datatable table-responsive">
                                <table id="warehouse_table" class="table border-top">
                                    ...
                                    <tr>
                                        ...
                                        <td>6U8IE</td>
                                        <td>Books</td>
                                        <td><span class="badge bg-label-warning">In Warehouse</span></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>73O1H</td>
                                        <td>Sneakers</td>
                                        <td><span class="badge bg-label-danger">Delayed</span></td>
                                        <td>
                                            <div class="table-actions">
                                                <a href="javascript:edit()"><i
                                                            data-toggle="tooltip" data-placement="top"
                                    ...
                                    <tr>
                                        ...
                                        <td>7W5G7U</td>
                                        <td>Clothing</td>
                                        <td><span class="badge bg-label-primary">Preparing For Delivery</span></td>
                                        <td>
                                            <div class="table-actions">
                                                <a href="javascript:edit()"><i
                                                            data-toggle="tooltip" data-placement="top"
