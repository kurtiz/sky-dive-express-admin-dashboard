...
function Sidebar() {
    var t = this;
    this.button = document.querySelector(".header__toggle-menu"), this.sidebar = document.querySelector(".sidebar"), this.backdropDesktop = document.querySelector(".sidebar-backdrop"), this.body = document.querySelector("body"), this.button && (this.button.addEventListener("click", function (e) {
        return t.toggle(e)
    }))
}
...
$((isTouchDevices && document.querySelector("html").classList.add("is-touch"), imgLoaded.on("always", function () {
    ...
    e.addEventListener("click", function (e) {
        var t = e.currentTarget, o = document.querySelector('[href="'.concat(t.getAttribute("data-toggle-tab"), '"]'));
        triggerEvent("click", o)
    })
