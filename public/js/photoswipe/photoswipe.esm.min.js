...
class b {
  constructor(t, i, s) {
    (this.data = t),
      ...
      (this.zoomLevels = new y(s.options, t, i, s)),
      ...
      (this.pan = { x: 0, y: 0 });
    const h = this.pswp.getContentClass(this.data, i);
    (this.content = new h(this.data, s, this)),
      (this.currZoomLevel = 1),
  ...
  load() {
    if (this.usePlaceholder() && !this.placeholder) {
      ...
      this.placeholder = new x(!!t && this.data.msrc, this.container);
    }
    this.content.load(),
      ...
      (this.pswp.dispatch("appendHeavy", { slide: this }).defaultPrevented ||
        ...
        this.content.state === d
          ...
          : (this.content.appendTo(this.container),
            this.placeholder && this.removePlaceholder()),
  ...
  destroy() {
    this.content.destroy(), this.pswp.dispatch("slideDestroy", { slide: this });
  }
  resize() {
...
class S {
  ...
  start() {
    (this.A = this.pswp.currSlide.currZoomLevel),
  ...
  change() {
    ...
    z(this.C, i, e), z(this.D, t, s);
    let c = (1 / h(i, e)) * h(t, s) * this.A;
    if (
      (c > o.zoomLevels.initial + o.zoomLevels.initial / 15 && (this.I = !0),
      c < r)
    )
      if (n.options.pinchToClose && !this.I && this.A <= o.zoomLevels.initial) {
        const t = 1 - (r - c) / (r / 1.2);
    ...
    const { pswp: t } = this,
      { currSlide: i } = t;
    i.currZoomLevel < i.zoomLevels.initial && !this.I && t.options.pinchToClose
      ? t.close()
      : this.correctZoomPan();
  }
  k(t, i) {
...
class C {
    ...
    this.F &&
      ...
      this.pswp.dispatch("pointerUp", { originalEvent: t }).defaultPrevented ||
        ...
        this.F < 2 &&
          ...
          ((this.isZooming = !1),
          this.zoomLevels.end(),
          1 === this.F && ((this.dragAxis = null), this.j()))));
  }
  X() {
  ...
  q(t, s) {
    if (this.G) {
      const h = this.B.findIndex((i) => i.id === t.pointerId);
      "up" === s && h > -1
        ? this.B.splice(h, 1)
        : "down" === s && -1 === h
        ? this.B.push(this.nt(t, {}))
        : h > -1 && this.nt(t, this.B[h]),
        (this.F = this.B.length),
        this.F > 0 && i(this.p1, this.B[0]),
        this.F > 1 && i(this.p2, this.B[1]);
    } else
      (this.F = 0),
        t.type.indexOf("touch") > -1
          ? t.touches &&
            ...
            this.F++,
            t.touches.length > 1 && (this.nt(t.touches[1], this.p2), this.F++))
...
class E {
  ...
  gt(t) {
    t.target === this.ft && this.vt();
  }
  vt() {
    this.yt || ((this.yt = !0), this.onFinish(), this.wt && this.wt());
  }
  destroy() {
...
class I {
  constructor(t, i, s) {
    (this.velocity = 1e3 * t),
      (this.xt = i || 0.75),
      (this.bt = s || 12),
      this.xt < 1 && (this.Mt = this.bt * Math.sqrt(1 - this.xt * this.xt));
  }
  easeFrame(t, i) {
    let s,
      h = 0;
    i /= 1e3;
    const e = Math.E ** (-this.xt * this.bt * i);
    if (1 === this.xt)
      (s = this.velocity + this.bt * t),
        (h = (t + s * i) * e),
        (this.velocity = h * -this.bt + s * e);
    else if (this.xt < 1) {
      s = (1 / this.Mt) * (this.xt * this.bt * t + this.velocity);
      const n = Math.cos(this.Mt * i),
        o = Math.sin(this.Mt * i);
      (h = e * (t * n + s * o)),
        (this.velocity =
          h * -this.bt * this.xt + e * (-this.Mt * t * o + this.Mt * s * n));
    }
    return h;
  }
}
    ...
    const u = () => {
      this.St &&
        ...
        Math.abs(p) < 1 && Math.abs(c.velocity) < 50
          ...
          : ((l = Date.now()), e(p + s), (this.St = requestAnimationFrame(u))));
    };
    this.St = requestAnimationFrame(u);
  }
  destroy() {
    this.St >= 0 && cancelAnimationFrame(this.St), (this.St = null);
  }
}
class Z {
  constructor() {
...
class H {
  ...
  init() {
    const { pswp: t } = this;
    (this.isRegistered = !1),
      (this.uiElementsData = [G, B, R, N, U, V]),
  ...
  registerElement(t) {
    this.isRegistered
      ? this.items.push(new O(this.pswp, t))
...
function K(t, i) {
  const s = i.getContentClass(t);
  if (!s) return;
  const h = new s(t, i);
  if (!h.lazyLoad) return;
  const { options: e } = i,
...
class j {
  ...
  addRecent(t) {
    if (!(this.At.indexOf(t) > -1))
      return this.At.length > 14 && this.At.pop(), this.At.unshift(t), !0;
  }
  loadSlideByIndex(t) {
...
class X {
  constructor(t, i, s) {
    (this.options = i.options),
      (this.instance = i),
      (this.data = t),
      s && ((this.slide = s), (this.pswp = s.pswp)),
...
class J {
  ...
  close() {
    ...
    return (
      ...
      t && t.currZoomLevel * t.width >= 4e3 && (this.It = 0),
      this.kt(),
      setTimeout(
        () => {
          this.Pt();
  ...
  Et() {
    this.pswp.off("firstZoomPan", this.Et),
      this.isOpening ||
        ((this.isOpening = !0),
        (this.isClosing = !1),
  ...
  kt() {
    ...
    if (
      ("fade" === s.showHideAnimationType
        ? ((s.showHideOpacity = !0), (this.Lt = !1))
        : "none" === s.showHideAnimationType
        ? ((s.showHideOpacity = !1), (this.It = 0), (this.Lt = !1))
        : this.isOpening && t.Ot
        ? (this.Lt = t.Ot)
        : (this.Lt = this.pswp.getThumbBounds()),
      (this.Ft = i.getPlaceholderElement()),
      t.animations.stopAll(),
      (this.Bt = this.It > 50),
      (this.Rt =
        Boolean(this.Lt) && (!this.isClosing || !t.mainScroll.isShifted())),
      this.Rt
        ? (this.Gt = s.showHideOpacity)
        : ((this.Gt = !0),
          this.isOpening && (i.zoomAndPanToInitial(), i.applyCurrentZoomPan())),
      (this.Nt = !this.Gt),
      (this.Ut = this.Gt ? t.template : t.bg),
      !this.Bt)
    )
      return (
        (this.It = 0),
    ...
    this.Rt && this.Lt.innerRect
      ? ((this.Zt = !0),
        (this.Vt = this.pswp.container),
      ...
      this.isOpening
        ? (this.Nt &&
          ...
          this.Gt && ((t.template.style.opacity = 0.003), t.applyBgOpacity(1)),
          this.Rt &&
            (this.Ht(),
            this.Ft &&
  ...
  Kt() {
    this.pswp.template.style.setProperty(
      ...
      this.isOpening
        ? (this.Ft && (this.Ft.style.opacity = 1), this.jt())
  ...
  jt() {
    ...
    this.Rt &&
      (this.Zt &&
        (this.Yt(this.Vt, "transform", "translate3d(0,0,0)"),
      ...
      this.Nt && this.Yt(t.bg, "opacity", t.options.bgOpacity),
      this.Gt && this.Yt(t.template, "opacity", 1);
  }
  Wt() {
    const { pswp: t } = this;
    this.Rt && this.Ht(!0),
      this.Nt && t.bgOpacity > 0.01 && this.Yt(t.bg, "opacity", 0),
      this.Gt && this.Yt(t.template, "opacity", 0);
  }
  Ht(t) {
    const { pswp: s } = this,
      { innerRect: h } = this.Lt,
    ...
    if (this.Zt) {
      const i = -n.x + (this.Lt.x - h.x) + h.w,
        s = -n.y + (this.Lt.y - h.y) + h.h,
        e = n.x - h.w,
        a = n.y - h.h;
      t
        ? (this.Yt(this.Vt, "transform", o(i, s)),
          this.Yt(this.qt, "transform", o(e, a)))
        : (r(this.Vt, i, s), r(this.qt, e, a));
    }
    i(e.pan, h || this.Lt),
      (e.currZoomLevel = this.Lt.w / e.width),
      t
...
class $ extends class extends class {
  ...
  constructor() {
    super(), (this.contentTypes = { image: Y, html: X });
  }
  getNumItems() {
    let t;
    ...
    i
      ...
      : (t = 0);
    return this.dispatch("numItems", { dataSource: i, numItems: t }).numItems;
  }
  addContentType(t, i) {
  ...
  getItemData(t) {
    ...
    let h = s;
    h instanceof Element && (h = this.$t(h));
    return this.dispatch("itemData", { itemData: h || {}, index: t }).itemData;
  }
  Qt(t) {
  ...
  $t(t) {
    ...
    return (
      ...
      s.dataset.cropped && (i.thumbCropped = !0),
      i
    );
  }
} {
  ...
  init() {
    ...
    return (
      ...
      this.dispatch("gettingData", this.currIndex, this.hi, !0),
      (this.Ot = this.getThumbBounds()),
      ...
      this.on("initialZoomInEnd", () => {
        this.setContent(this.mainScroll.itemHolders[0], this.currIndex - 1),
          ...
          this.events.add(window, "resize", this.ei.bind(this)),
          this.events.add(window, "scroll", this.ni.bind(this)),
  ...
  getThumbBounds() {
    return (function (t, i, s) {
      ...
      const { element: e } = i;
      if (!e || !1 === s.options.thumbSelector) return;
      const n = s.options.thumbSelector || "img",
        o = e.matches(n) ? e : e.querySelector(n);
      if (!o) return;
      ...
      const l = r.width / a,
        ...
        d = (r.width - a * u) / 2,
        m = (r.height - c * u) / 2,
        f = { x: r.left + d, y: r.top + m, w: a * u };
      return (f.innerRect = { w: r.width, h: r.height, x: d, y: m }), f;
...
export { X as Content, Y as ImageContent, $ as default };
