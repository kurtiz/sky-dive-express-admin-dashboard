                    ...
                    return function (t, e, n, r) {
                        var a, o, i, l, s = function (e, n) {
                                ...
                                n = e, this.$ = function (t, e) {
                                    ...
                                    var a = this.api(!0), o = a.rows(t), i = o.settings()[0], l = i.aoData[o[0][0]];
                                ...
                                var i = this, l = n === r, u = this.length;
                                for (var c in l && (n = {}), this.oApi = this.internal = a.internal, s.ext.internal) c && (this[c] = qe(c));
                                return this.each((function () {
                                    var e, a = u > 1 ? fe({}, n, !0) : n, o = 0, c = this.getAttribute("id"), f = !1,
                                        d = s.defaults, h = t(this);
                                    if ("table" == this.nodeName.toLowerCase()) {
                                        ...
                                        t.extend(!0, D, a.oLanguage), D.sUrl ? (t.ajax({
                                            ...
                                            url: D.sUrl,
                                            success: function (e) {
                                                F(d.oLanguage, e), L(e), t.extend(!0, D, e, m.oInit.oLanguage), pe(m, null, "i18n", [m]), Nt(m)
                                            },
                                            error: function () {
                                                Nt(m)
                                            }
                                        }), f = !0) : pe(m, null, "i18n", [m]), null === a.asStripeClasses && (m.asStripeClasses = [S.sStripeOdd, S.sStripeEven]);
                                        var _ = m.asStripeClasses, C = h.children("tbody").find("tr").eq(0);
                                        -1 !== t.inArray(!0, t.map(_, (function (t, e) {
                                            return C.hasClass(t)
                                        }))) && (t("tbody tr", this).removeClass(_.join(" ")), m.asDestroyStripes = _.slice());
                                        var w, T = [], x = this.getElementsByTagName("thead");
                                        if (0 !== x.length && (dt(m.aoHeader, x[0]), T = ht(m)), null === a.aoColumns) for (w = [], o = 0, e = T.length; o < e; o++) w.push(null); else w = a.aoColumns;
                                        for (o = 0, e = w.length; o < e; o++) O(m, T ? T[o] : null);
                                        if (X(m, a.aoColumnDefs, w, (function (t, e) {
                                            M(m, t, e)
                                        })), C.length) {
                                            var A = function (t, e) {
                                                return null !== t.getAttribute("data-" + e) ? e : null
                                            };
                                            t(C[0]).children("th, td").each((function (t, e) {
                                                var n = m.aoColumns[t];
                                                if (n.mData === t) {
                                        ...
                                        var I = m.oFeatures, R = function () {
                                            ...
                                            re(m), I.bSort && he(m, "aoDrawCallback", (function () {
                                                ...
                                                (m.bSorted || "ssp" === be(m) || I.bDeferRender) && re(m)
                                            }), "sc");
                                            ...
                                            if (0 === u.length && i.length > 0 && ("" !== m.oScroll.sX || "" !== m.oScroll.sY) && (u = t("<tfoot/>").appendTo(h)), 0 === u.length || 0 === u.children().length ? h.addClass(S.sNoFooter) : u.length > 0 && (m.nTFoot = u[0], dt(m.aoFooter, m.nTFoot)), a.aaData) for (o = 0; o < a.aaData.length; o++) J(m, a.aaData[o]); else (m.bDeferLoading || "dom" == be(m)) && q(m, t(m.nTBody).children("tr"));
                                            m.aiDisplay = m.aiDisplayMaster.slice(), m.bInitialised = !0, !1 === f && Nt(m)
                                        };
                                        he(m, "aoDrawCallback", oe, "state_save"), a.bStateSave ? (I.bStateSave = !0, ie(m, 0, R)) : R()
                            ...
                            p = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, g = function (t) {
                                ...
                                return !!g(t) || (e && r && (t = b(t, e)), n && r && (t = t.replace(p, "")), !isNaN(parseFloat(t)) && isFinite(t))
                            }, S = function (t, e, n) {
                                ...
                                if (Array.isArray(e)) for (var n = 0; n < e.length; n++) x(t, e[n]); else t.push(e);
                                return t
                            }, A = function (t, e) {
                        ...
                        function L(t) {
                            var e = s.defaults.oLanguage, n = e.sDecimal;
                            if (n && Oe(n), t) {
                        ...
                        Array.isArray || (Array.isArray = function (t) {
                            ...
                            throttle: function (t, e) {
                                ...
                                var n = function (t, e, a) {
                                    for (var o, i, l, s, u, c = Z(a), f = c[c.length - 1], d = 0, h = c.length - 1; d < h; d++) {
                                        ...
                                        if (i = c[d].match(z), l = c[d].match(Y), i) {
                                            if (c[d] = c[d].replace(z, ""), t[c[d]] = [], (o = c.slice()).splice(0, d + 1), u = o.join("."), Array.isArray(e)) for (var p = 0, g = e.length; p < g; p++) n(s = {}, e[p], u), t[c[d]].push(s); else t[c[d]] = e;
                                            return
                                        }
                                ...
                                var a = function (t, e, n) {
                                    var o, i, l, s;
                                    if ("" !== n) for (var u = Z(n), c = 0, f = u.length; c < f; c++) {
                                        if (o = u[c].match(z), i = u[c].match(Y), o) {
                                            if (u[c] = u[c].replace(z, ""), "" !== u[c] && (t = t[u[c]]), l = [], u.splice(0, c + 1), s = u.join("."), Array.isArray(t)) for (var d = 0, h = t.length; d < h; d++) l.push(a(t[d], e, s));
                                            var p = o[0].substring(1, o[0].length - 1);
                                            t = "" === p ? l : l.join(p);
                                            break
                                        }
                                        if (i) u[c] = u[c].replace(Y, ""), t = t[u[c]](); else {
                        ...
                        function P(t) {
                            ...
                            if (e) for (var n = 0, r = e.length; n < r; n++) e[n] && F(s.models.oSearch, e[n])
                        }
                        ...
                        function N(n) {
                            if (!s.__browser) {
                                ...
                                var a = t("<div/>").css({
                                        ...
                                        width: 100,
                                        overflow: "scroll"
                                    }).append(t("<div/>").css({width: "100%", height: 10}))).appendTo("body"),
                                    o = a.children(), i = o.children();
                        ...
                        function O(e, r) {
                            var a = s.defaults.column, o = e.aoColumns.length, i = t.extend({}, s.models.oColumn, a, {
                            ...
                            l[o] = t.extend({}, s.models.oSearch, l[o]), M(e, o, t(r).data())
                        }

                        function M(e, n, a) {
                            var o = e.aoColumns[n], i = e.oClasses, l = t(o.nTh);
                            if (!o.sWidthOrig) {
                            ...
                            if (a !== r && null !== a) {
                                ...
                                var c = o.sClass;
                                t.extend(o, a), ce(o, a, "sWidth", "sWidthOrig"), c !== o.sClass && (o.sClass = c + " " + o.sClass), a.iDataSort !== r && (o.aDataSort = [a.iDataSort]), ce(o, a, "aDataSort")
                            }
                            var f = o.mData, d = K(f), h = o.mRender ? K(o.mRender) : null, p = function (t) {
                            ...
                            o._bAttrSrc = t.isPlainObject(f) && (p(f.sort) || p(f.type) || p(f.filter)), o._setter = null, o.fnGetData = function (t, e, n) {
                                ...
                                return Q(f)(t, e, n)
                            }, "number" != typeof f && (e._rowReadObject = !0), e.oFeatures.bSort || (o.bSortable = !1, l.addClass(i.sSortableNone));
                            var g = -1 !== t.inArray("asc", o.asSorting), v = -1 !== t.inArray("desc", o.asSorting);
                            o.bSortable && (g || v) ? g && !v ? (o.sSortingClass = i.sSortableAsc, o.sSortingClassJUI = i.sSortJUIAscAllowed) : !g && v ? (o.sSortingClass = i.sSortableDesc, o.sSortingClassJUI = i.sSortJUIDescAllowed) : (o.sSortingClass = i.sSortable, o.sSortingClassJUI = i.sSortJUI) : (o.sSortingClass = i.sSortableNone, o.sSortingClassJUI = "")
                        }
                        ...
                        function E(e, n) {
                            var r = U(e, "bVisible"), a = t.inArray(n, r);
                            return -1 !== a ? a : null
                        }
                        ...
                        function V(t) {
                            var e, n, a, o, i, l, u, c, f, d = t.aoColumns, h = t.aoData, p = s.ext.type.detect;
                            for (e = 0, n = d.length; e < n; e++) if (f = [], !(u = d[e]).sType && u._sManualType) u.sType = u._sManualType; else if (!u.sType) {
                                for (a = 0, o = p.length; a < o; a++) {
                                    for (i = 0, l = h.length; i < l && (f[i] === r && (f[i] = G(t, i, e, "type")), (c = p[a](f[i], t)) || a === p.length - 1) && ("html" !== c || g(f[i])); i++) ;
                                    if (c) {
                                        u.sType = c;
                                        break
                                    }
                        ...
                        function X(e, n, a, o) {
                            ...
                            if (n) for (i = n.length - 1; i >= 0; i--) {
                                ...
                                for (Array.isArray(p) || (p = [p]), s = 0, u = p.length; s < u; s++) if ("number" == typeof p[s] && p[s] >= 0) {
                        ...
                        function J(e, n, a, o) {
                            var i = e.aoData.length,
                                l = t.extend(!0, {}, s.models.oRow, {src: a ? "dom" : "data", idx: i});
                        ...
                        function G(t, e, n, a) {
                            ...
                            var o = t.iDraw, i = t.aoColumns[n], l = t.aoData[e]._aData, u = i.sDefaultContent,
                        ...
                        function at(t, e, n, a) {
                            var o, i, l, s = [], u = e.firstChild, c = 0, f = t.aoColumns, d = t._rowReadObject;
                            a = a !== r ? a : d ? {} : [];
                            var h = function (t, e) {
                                if ("string" == typeof t) {
                                    var n = t.indexOf("@");
                                ...
                                n !== r && n !== c || (i = f[c], l = t.innerHTML.trim(), i && i._bAttrSrc ? (Q(i.mData._)(a, l), h(i.mData.sort, t), h(i.mData.type, t), h(i.mData.filter, t)) : d ? (i._setter || (i._setter = Q(i.mData)), i._setter(a, l)) : a[c] = l), c++
                            };
                            if (u) for (; u;) "TD" != (o = u.nodeName.toUpperCase()) && "TH" != o || (p(u), s.push(u)), u = u.nextSibling; else for (var g = 0, v = (s = e.anCells).length; g < v; g++) p(s[g]);
                        ...
                        function ot(e, r, a, o) {
                            var i, l, s, u, c, f, d = e.aoData[r], h = d._aData, p = [];
                            if (null === d.nTr) {
                                for (i = a || n.createElement("tr"), d.nTr = i, d.anCells = p, i._DT_RowIndex = r, it(e, d), u = 0, c = e.aoColumns.length; u < c; u++) s = e.aoColumns[u], (l = (f = !a) ? n.createElement(s.sCellType) : o[u])._DT_CellIndex = {
                                    row: r,
                                    column: u
                                }, p.push(l), !f && (!s.mRender && s.mData === u || t.isPlainObject(s.mData) && s.mData._ === u + ".display") || (l.innerHTML = G(e, r, u, "display")), s.sClass && (l.className += " " + s.sClass), s.bVisible && !a ? i.appendChild(l) : !s.bVisible && a && l.parentNode.removeChild(l), s.fnCreatedCell && s.fnCreatedCell.call(e.oInstance, l, G(e, r, u), h, r, u);
                        ...
                        function lt(e) {
                            var n, r, a, o, i, l = e.nTHead, s = e.nTFoot, u = 0 === t("th, td", l).length,
                                c = e.oClasses, f = e.aoColumns;
                            for (u && (o = t("<tr/>").appendTo(l)), n = 0, r = f.length; n < r; n++) i = f[n], a = t(i.nTh).addClass(i.sClass), u && a.appendTo(o), e.oFeatures.bSort && (a.addClass(i.sSortingClass), !1 !== i.bSortable && (a.attr("tabindex", e.iTabIndex).attr("aria-controls", e.sTableId), ne(e, i.nTh, n))), i.sTitle != a[0].innerHTML && a.html(i.sTitle), ve(e, "header")(e, a, i, c);
                        ...
                        function st(e, n, a) {
                            var o, i, l, s, u, c, f, d, h, p = [], g = [], v = e.aoColumns.length;
                            if (n) {
                                for (a === r && (a = !1), o = 0, i = n.length; o < i; o++) {
                                    for (p[o] = n[o].slice(), p[o].nTr = n[o].nTr, l = v - 1; l >= 0; l--) e.aoColumns[l].bVisible || a || p[o].splice(l, 1);
                                    g.push([])
                                }
                                for (o = 0, i = p.length; o < i; o++) {
                                    if (f = p[o].nTr) for (; c = f.firstChild;) f.removeChild(c);
                                    for (l = 0, s = p[o].length; l < s; l++) if (d = 1, h = 1, g[o][l] === r) {
                        ...
                        function ut(e, n) {
                            !function (t) {
                                var e = "ssp" == be(t), n = t.iInitDisplayStart;
                                n !== r && -1 !== n && (t._iDisplayStart = e ? n : n >= t.fnRecordsDisplay() ? 0 : n, t.iInitDisplayStart = -1)
                            }(e);
                            var a = pe(e, "aoPreDrawCallback", "preDraw", [e]);
                            if (-1 === t.inArray(!1, a)) {
                                var o = [], i = 0, l = e.asStripeClasses, s = l.length, u = e.oLanguage,
                                    c = "ssp" == be(e), f = e.aiDisplay, d = e._iDisplayStart, h = e.fnDisplayEnd();
                                if (e.bDrawing = !0, e.bDeferLoading) e.bDeferLoading = !1, e.iDraw++, Bt(e, !1); else if (c) {
                                    if (!e.bDestroying && !n) return void gt(e)
                                } else e.iDraw++;
                                if (0 !== f.length) for (var p = c ? 0 : d, g = c ? e.aoData.length : h, v = p; v < g; v++) {
                                    var b = f[v], m = e.aoData[b];
                                    null === m.nTr && ot(e, b);
                                    var S = m.nTr;
                                    if (0 !== s) {
                                        var y = l[i % s];
                                    ...
                                    pe(e, "aoRowCallback", null, [S, m._aData, i, v, b]), o.push(S), i++
                                } else {
                                    var D = u.sZeroRecords;
                                    1 == e.iDraw && "ajax" == be(e) ? D = u.sLoadingRecords : u.sEmptyTable && 0 === e.fnRecordsTotal() && (D = u.sEmptyTable), o[0] = t("<tr/>", {class: s ? l[0] : ""}).append(t("<td />", {
                                        valign: "top",
                                        colSpan: B(e),
                        ...
                        function ft(e) {
                            var n = e.oClasses, r = t(e.nTable), a = t("<div/>").insertBefore(r), o = e.oFeatures,
                                i = t("<div/>", {
                            ...
                            for (var l, u, c, f, d, h, p = e.sDom.split(""), g = 0; g < p.length; g++) {
                                if (l = null, "<" == (u = p[g])) {
                                    ...
                                    i.append(c), i = t(c)
                                } else if (">" == u) i = i.parent(); else if ("l" == u && o.bPaginate && o.bLengthChange) l = Mt(e); else if ("f" == u && o.bFilter) l = St(e); else if ("r" == u && o.bProcessing) l = Et(e); else if ("t" == u) l = Ut(e); else if ("i" == u && o.bInfo) l = Rt(e); else if ("p" == u && o.bPaginate) l = kt(e); else if (0 !== s.ext.feature.length) for (var b = s.ext.feature, m = 0, S = b.length; m < S; m++) if (u == b[m].cFeature) {
                                    l = b[m].fnInit(e);
                                    break
                                }
                                if (l) {
                        ...
                        function dt(e, n) {
                            var r, a, o, i, l, s, u, c, f, d, h = t(n).children("tr"), p = function (t, e, n) {
                                for (var r = t[e]; r[n];) n++;
                                return n
                            };
                            for (e.splice(0, e.length), o = 0, s = h.length; o < s; o++) e.push([]);
                            for (o = 0, s = h.length; o < s; o++) for (0, a = (r = h[o]).firstChild; a;) {
                                if ("TD" == a.nodeName.toUpperCase() || "TH" == a.nodeName.toUpperCase()) for (c = (c = 1 * a.getAttribute("colspan")) && 0 !== c && 1 !== c ? c : 1, f = (f = 1 * a.getAttribute("rowspan")) && 0 !== f && 1 !== f ? f : 1, u = p(e, o, 0), d = 1 === c, l = 0; l < c; l++) for (i = 0; i < f; i++) e[o + i][u + l] = {
                                    cell: a,
                                    unique: d
                                }, e[o + i].nTr = r;
                                a = a.nextSibling
                        ...
                        function ht(t, e, n) {
                            ...
                            for (var a = 0, o = n.length; a < o; a++) for (var i = 0, l = n[a].length; i < l; i++) !n[a][i].unique || r[i] && t.bSortCellsTop || (r[i] = n[a][i].cell);
                            return r
                        }
                        ...
                        function pt(e, n, r) {
                            ...
                            var f = {
                                ...
                                error: function (n, r, a) {
                                    ...
                                    -1 === t.inArray(!0, o) && ("parsererror" == r ? ue(e, 0, "Invalid JSON response", 1) : 4 === n.readyState && ue(e, 0, "Ajax error", 7)), Bt(e, !1)
                                }
                            };
                        ...
                        function gt(t) {
                            t.iDraw++, Bt(t, !0), pt(t, vt(t), (function (e) {
                                bt(t, e)
                            }))
                        }

                        function vt(e) {
                            var n, r, a, o, i = e.aoColumns, l = i.length, u = e.oFeatures, c = e.oPreviousSearch,
                                f = e.aoPreSearchCols, d = [], h = Kt(e), p = e._iDisplayStart,
                                g = !1 !== u.bPaginate ? e._iDisplayLength : -1, v = function (t, e) {
                                    d.push({name: t, value: e})
                                };
                            v("sEcho", e.iDraw), v("iColumns", l), v("sColumns", y(i, "sName").join(",")), v("iDisplayStart", p), v("iDisplayLength", g);
                            var b = {
                                draw: e.iDraw,
                                columns: [],
                                order: [],
                            ...
                            for (n = 0; n < l; n++) a = i[n], o = f[n], r = "function" == typeof a.mData ? "function" : a.mData, b.columns.push({
                                data: r,
                                name: a.sName,
                            ...
                            u.bFilter && (v("sSearch", c.sSearch), v("bRegex", c.bRegex)), u.bSort && (t.each(h, (function (t, e) {
                                b.order.push({
                                    column: e.col,
                                    dir: e.dir
                        ...
                        function bt(t, e) {
                            var n = function (t, n) {
                                ...
                                }, a = mt(t, e), o = n("sEcho", "draw"), i = n("iTotalRecords", "recordsTotal"),
                        ...
                        function St(e) {
                            var r = e.oClasses, a = e.sTableId, o = e.oLanguage, i = e.oPreviousSearch,
                                l = e.aanFeatures, s = '<input type="search" class="' + r.sFilterInput + '"/>',
                                u = o.sSearch;
                            u = u.match(/_INPUT_/) ? u.replace("_INPUT_", s) : u + s;
                            var c = t("<div/>", {
                                    id: l.f ? null : a + "_filter",
                                    class: r.sFilter
                                }).append(t("<label/>").append(u)), f = function (t) {
                                    l.f;
                        ...
                        function yt(t, e, n) {
                            ...
                            if (V(t), "ssp" != be(t)) {
                                Ct(t, e.sSearch, n, l(e), e.bSmart, e.bCaseInsensitive, e.return), i(e);
                        ...
                        function _t(t, e, n, r, a, o) {
                            if ("" !== e) {
                                for (var i, l = [], s = t.aiDisplay, u = wt(e, r, a, o), c = 0; c < s.length; c++) i = t.aoData[s[c]]._aFilterData[n], u.test(i) && l.push(s[c]);
                                t.aiDisplay = l
                            }
                        }

                        function Ct(t, e, n, r, a, o) {
                            var i, l, u, c = wt(e, r, a, o), f = t.oPreviousSearch.sSearch, d = t.aiDisplayMaster,
                                h = [];
                            if (0 !== s.ext.search.length && (n = !0), l = It(t), e.length <= 0) t.aiDisplay = d.slice(); else {
                        ...
                        var Tt = s.util.escapeRegex, xt = t("<div>")[0], At = xt.textContent !== r;

                        function It(t) {
                            var e, n, r, a, o, i, l, s = t.aoColumns, u = !1;
                            for (e = 0, r = t.aoData.length; e < r; e++) if (!(l = t.aoData[e])._aFilterData) {
                                for (o = [], n = 0, a = s.length; n < a; n++) s[n].bSearchable ? (null === (i = G(t, e, n, "filter")) && (i = ""), "string" != typeof i && i.toString && (i = i.toString())) : i = "", i.indexOf && -1 !== i.indexOf("&") && (xt.innerHTML = i, i = At ? xt.textContent : xt.innerText), i.replace && (i = i.replace(/[\r\n\u2028]/g, "")), o.push(i);
                        ...
                        function Pt(e) {
                            ...
                            if (0 !== n.length) {
                                var r = e.oLanguage, a = e._iDisplayStart + 1, o = e.fnDisplayEnd(),
                                    i = e.fnRecordsTotal(), l = e.fnRecordsDisplay(), s = l ? r.sInfo : r.sInfoEmpty;
                        ...
                        function jt(t, e) {
                            var n = t.fnFormatNumber, r = t._iDisplayStart + 1, a = t._iDisplayLength,
                                o = t.fnRecordsDisplay(), i = -1 === a;
                        ...
                        function Nt(t) {
                            var e, n, r, a = t.iInitDisplayStart, o = t.aoColumns, i = t.oFeatures, l = t.bDeferLoading;
                            if (t.bInitialised) {
                                ...
                                ("ssp" != s || l) && ("ajax" == s ? pt(t, [], (function (n) {
                                    ...
                                    t.iInitDisplayStart = a, ct(t), Bt(t, !1), Ht(t, n)
                                })) : (Bt(t, !1), Ht(t)))
                        ...
                        function Ht(t, e) {
                            t._bInitComplete = !0, (e || t.oInit.aaData) && k(t), pe(t, null, "plugin-init", [t, e]), pe(t, "aoInitComplete", "init", [t, e])
                        }
                        ...
                        function kt(e) {
                            var n = e.sPaginationType, r = s.ext.pager[n], a = "function" == typeof r,
                                o = function (t) {
                                    ut(t)
                            ...
                            return a || r.fnInit(e, i, o), l.p || (i.id = e.sTableId + "_paginate", e.aoDrawCallback.push({
                                fn: function (t) {
                                    if (a) {
                                        var e, n, i = t._iDisplayStart, s = t._iDisplayLength, u = t.fnRecordsDisplay(),
                                            c = -1 === s, f = c ? 0 : Math.ceil(i / s), d = c ? 1 : Math.ceil(u / s),
                                            h = r(f, d);
                                        for (e = 0, n = l.p.length; e < n; e++) ve(t, "pageButton")(t, l.p[e], e, h, f, d)
                                    } else r.fnUpdate(t, o)
                                }, sName: "pagination"
                            })), i
                        }
                        ...
                        function Wt(t, e, n) {
                            ...
                            return t._iDisplayStart = r, i && (pe(t, null, "page", [t]), n && ut(t)), i
                        }
                        ...
                        function Ut(e) {
                            var n = t(e.nTable), r = e.oScroll;
                            if ("" === r.sX && "" === r.sY) return e.nTable;
                            var a = r.sX, o = r.sY, i = e.oClasses, l = n.children("caption"),
                                s = l.length ? l[0]._captionSide : null, u = t(n[0].cloneNode(!1)),
                                c = t(n[0].cloneNode(!1)), f = n.children("tfoot"), d = "<div/>", h = function (t) {
                                    return t ? Zt(t) : null
                                };
                            f.length || (f = null);
                            ...
                            var g = p.children(), v = g[0], b = g[1], m = f ? g[2] : null;
                            return a && t(b).on("scroll.DT", (function (t) {
                                var e = this.scrollLeft;
                                v.scrollLeft = e, f && (m.scrollLeft = e)
                            })), t(b).css("max-height", o), r.bCollapse || t(b).css("height", o), e.nScrollHead = v, e.nScrollBody = b, e.nScrollFoot = m, e.aoDrawCallback.push({
                                fn: Vt,
                                sName: "scrolling"
                            }), p[0]
                        }
                        ...
                        function Vt(n) {
                            var a, o, i, l, s, u, c, f, d, h = n.oScroll, p = h.sX, g = h.sXInner, v = h.sY,
                                b = h.iBarWidth, m = t(n.nScrollHead), S = m[0].style, D = m.children("div"),
                                _ = D[0].style, C = D.children("table"), w = n.nScrollBody, T = t(w), x = w.style,
                                A = t(n.nScrollFoot).children("div"), I = A.children("table"), F = t(n.nTHead),
                                L = t(n.nTable), R = L[0], P = R.style, j = n.nTFoot ? t(n.nTFoot) : null,
                                N = n.oBrowser, H = N.bScrollOversize, O = (y(n.aoColumns, "nTh"), []), M = [], E = [],
                                B = [], U = function (t) {
                                    var e = t.style;
                                    e.paddingTop = "0", e.paddingBottom = "0", e.borderTopWidth = "0", e.borderBottomWidth = "0", e.height = 0
                                }, V = w.scrollHeight > w.clientHeight;
                            if (n.scrollBarVis !== V && n.scrollBarVis !== r) return n.scrollBarVis = V, void k(n);
                            n.scrollBarVis = V, L.children("thead, tfoot").remove(), j && (u = j.clone().prependTo(L), o = j.find("tr"), l = u.find("tr"), u.find("[id]").removeAttr("id")), s = F.clone().prependTo(L), a = F.find("tr"), i = s.find("tr"), s.find("th, td").removeAttr("tabindex"), s.find("[id]").removeAttr("id"), p || (x.width = "100%", m[0].style.width = "100%"), t.each(ht(n, s), (function (t, e) {
                                ...
                                t.style.width = ""
                            }), l), d = L.outerWidth(), "" === p ? (P.width = "100%", H && (L.find("tbody").height() > w.offsetHeight || "scroll" == T.css("overflow-y")) && (P.width = Zt(L.outerWidth() - b)), d = L.outerWidth()) : "" !== g && (P.width = Zt(g), d = L.outerWidth()), Xt(U, i), Xt((function (n) {
                            ...
                            }), l), Math.round(L.outerWidth()) < Math.round(d) ? (f = w.scrollHeight > w.offsetHeight || "scroll" == T.css("overflow-y") ? d + b : d, H && (w.scrollHeight > w.offsetHeight || "scroll" == T.css("overflow-y")) && (P.width = Zt(f - b)), "" !== p && "" === g || ue(n, 1, "Possible column misalignment", 6)) : f = "100%", x.width = Zt(f), S.width = Zt(f), j && (n.nScrollFoot.style.width = Zt(f)), v || H && (x.height = Zt(R.offsetHeight + b));
                            var X = L.outerWidth();
                            C[0].style.width = Zt(X), _.width = Zt(X);
                            var J = L.height() > w.clientHeight || "scroll" == T.css("overflow-y"),
                                q = "padding" + (N.bScrollbarLeft ? "Left" : "Right");
                            _[q] = J ? b + "px" : "0px", j && (I[0].style.width = Zt(X), A[0].style.width = Zt(X), A[0].style[q] = J ? b + "px" : "0px"), L.children("colgroup").insertBefore(L.children("thead")), T.trigger("scroll"), !n.bSorted && !n.bFiltered || n._drawHold || (w.scrollTop = 0)
                        }
                        ...
                        function qt(n) {
                            var r, a, o, i = n.nTable, l = n.aoColumns, s = n.oScroll, u = s.sY, c = s.sX,
                                f = s.sXInner, d = l.length, h = U(n, "bVisible"), p = t("th", n.nTHead),
                                g = i.getAttribute("width"), v = i.parentNode, b = !1, m = n.oBrowser,
                                S = m.bScrollOversize, y = i.style.width;
                            for (y && -1 !== y.indexOf("%") && (g = y), r = 0; r < h.length; r++) null !== (a = l[h[r]]).sWidth && (a.sWidth = $t(a.sWidthOrig, v), b = !0);
                            if (S || !b && !c && !u && d == B(n) && d == p.length) for (r = 0; r < d; r++) {
                                var D = W(n, r);
                                ...
                                if (n.aoData.length) for (r = 0; r < h.length; r++) a = l[o = h[r]], t(zt(n, o)).clone(!1).append(a.sContentPadding).appendTo(C);
                                ...
                                c && f ? _.width(f) : c ? (_.css("width", "auto"), _.removeAttr("width"), _.width() < v.clientWidth && g && _.width(v.clientWidth)) : u ? _.width(v.clientWidth) : g && _.width(g);
                                var T = 0;
                                for (r = 0; r < h.length; r++) {
                                    var x = t(p[r]), A = x.outerWidth() - x.width(),
                        ...
                        function $t(e, r) {
                            if (!e) return 0;
                            var a = t("<div/>").css("width", Zt(e)).appendTo(r || n.body), o = a[0].offsetWidth;
                            return a.remove(), o
                        }
                        ...
                        function Kt(e) {
                            var n, a, o, i, l, u, c, f = [], d = e.aoColumns, h = e.aaSortingFixed,
                                p = t.isPlainObject(h), g = [], v = function (e) {
                                    e.length && !Array.isArray(e[0]) ? g.push(e) : t.merge(g, e)
                                };
                            for (Array.isArray(h) && v(h), p && h.pre && v(h.pre), v(e.aaSorting), p && h.post && v(h.post), n = 0; n < g.length; n++) for (a = 0, o = (i = d[c = g[n][0]].aDataSort).length; a < o; a++) u = d[l = i[a]].sType || "string", g[n]._idx === r && (g[n]._idx = t.inArray(g[n][1], d[l].asSorting)), f.push({
                                src: c,
                                col: l,
                                dir: g[n][1],
                                index: g[n]._idx,
                        ...
                        function Qt(t) {
                            var e, n, r, a, o, i = [], l = s.ext.type.order, u = t.aoData, c = (t.aoColumns, 0),
                                f = t.aiDisplayMaster;
                            ...
                            if ("ssp" != be(t) && 0 !== o.length) {
                                ...
                                c === o.length ? f.sort((function (t, e) {
                                    var n, r, a, l, s, c = o.length, f = u[t]._aSortData, d = u[e]._aSortData;
                                    for (a = 0; a < c; a++) if (0 != (l = (n = f[(s = o[a]).col]) < (r = d[s.col]) ? -1 : n > r ? 1 : 0)) return "asc" === s.dir ? l : -l;
                                    return (n = i[t]) < (r = i[e]) ? -1 : n > r ? 1 : 0
                                })) : f.sort((function (t, e) {
                                    var n, r, a, s, c, f = o.length, d = u[t]._aSortData, h = u[e]._aSortData;
                                    for (a = 0; a < f; a++) if (n = d[(c = o[a]).col], r = h[c.col], 0 !== (s = (l[c.type + "-" + c.dir] || l["string-" + c.dir])(n, r))) return s;
                                    return (n = i[t]) < (r = i[e]) ? -1 : n > r ? 1 : 0
                                }))
                            }
                            t.bSorted = !0
                        ...
                        function te(t) {
                            for (var e, n, r = t.aoColumns, a = Kt(t), o = t.oLanguage.oAria, i = 0, l = r.length; i < l; i++) {
                                var s = r[i], u = s.asSorting, c = s.ariaTitle || s.sTitle.replace(/<.*?>/g, ""),
                                    f = s.nTh;
                        ...
                        function ne(t, e, n, r) {
                            ...
                            de(e, {}, (function (e) {
                                !1 !== a.bSortable && (t.oFeatures.bProcessing ? (Bt(t, !0), setTimeout((function () {
                                    ee(t, n, e.shiftKey, r), "ssp" !== be(t) && Bt(t, !1)
                                }), 0)) : ee(t, n, e.shiftKey, r))
                            }))
                        }

                        function re(e) {
                            var n, r, a, o = e.aLastSort, i = e.oClasses.sSortColumn, l = Kt(e), s = e.oFeatures;
                        ...
                        function ae(t, e) {
                            var n, r, a, o = t.aoColumns[e], i = s.ext.order[o.sSortDataType];
                            i && (n = i.call(t.oInstance, t, e, E(t, e)));
                            for (var l = s.ext.type.order[o.sType + "-pre"], u = 0, c = t.aoData.length; u < c; u++) (r = t.aoData[u])._aSortData || (r._aSortData = []), r._aSortData[e] && !i || (a = i ? n[u] : G(t, u, e, "sort"), r._aSortData[e] = l ? l(a) : a)
                        }
                        ...
                        function se(e) {
                            var n = s.settings, r = t.inArray(e, y(n, "nTable"));
                            return -1 !== r ? n[r] : null
                        }
                        ...
                        function ue(t, n, r, a) {
                            if (r = "DataTables warning: " + (t ? "table id=" + t.sTableId + " - " : "") + r, a && (r += ". For more information about this error, please see http://datatables.net/tn/" + a), n) e.console && console.log && console.log(r); else {
                                var o = s.ext, i = o.sErrMode || o.errMode;
                                if (t && pe(t, null, "error", [t, a, r]), "alert" == i) alert(r); else {
                        ...
                        function ve(e, n) {
                            var r = e.renderer, a = s.ext.renderer[n];
                        ...
                        var me = [], Se = Array.prototype;
                        o = function (e, n) {
                            if (!(this instanceof o)) return new o(e, n);
                            var r = [], a = function (e) {
                                var n = function (e) {
                                    var n, r, a = s.settings, o = t.map(a, (function (t, e) {
                                        return t.nTable
                                    }));
                            ...
                            if (Array.isArray(e)) for (var i = 0, l = e.length; i < l; i++) a(e[i]); else a(e);
                            ...
                            any: function () {
                                ...
                                var e = [];
                                if (Se.filter) e = Se.filter.call(this, t, this); else for (var n = 0, r = this.length; n < r; n++) t.call(this, this[n], n, this) && e.push(this[n]);
                                ...
                                var i, l, s, u, c, f, d, h, p = [], g = this.context, v = this.selector;
                                for ("string" == typeof t && (a = n, n = e, e = t, t = !1), l = 0, s = g.length; l < s; l++) {
                                    var b = new o(g[l]);
                                    if ("table" === e) (i = n.call(b, g[l], l)) !== r && p.push(i); else if ("columns" === e || "rows" === e) (i = n.call(b, g[l], this[l], l)) !== r && p.push(i); else if ("column" === e || "column-rows" === e || "row" === e || "cell" === e) for (d = this[l], "column-rows" === e && (f = Te(g[l], v.opts)), u = 0, c = d.length; u < c; u++) h = d[u], (i = "cell" === e ? n.call(b, g[l], h.row, h.column, l, u) : n.call(b, g[l], h, l, u, f)) !== r && p.push(i)
                                }
                                if (p.length || a) {
                                    var m = new o(g, t ? p.concat.apply([], p) : p), S = m.selector;
                                    return S.rows = v.rows, S.cols = v.cols, S.opts = v.opts, m
                                }
                                return this
                                ...
                                var e = [];
                                if (Se.map) e = Se.map.call(this, t, this); else for (var n = 0, r = this.length; n < r; n++) e.push(t.call(this, this[n], n));
                                return new o(this.context, e)
                            }, pluck: function (t) {
                                let e = s.util.get(t);
                            ...
                            if (Array.isArray(e)) for (var r = 0, a = e.length; r < a; r++) o.register(e[r], n); else {
                                var i, l, s, u, c = e.split("."), f = me, d = function (t, e) {
                        ...
                        i("tables()", (function (t) {
                            ...
                            var e = this.context[0], n = e._iDisplayStart,
                                a = e.oFeatures.bPaginate ? e._iDisplayLength : -1, o = e.fnRecordsDisplay(),
                                i = -1 === a;
                            return {
                        ...
                        var _e = function (t, e, n, o, i) {
                            var l, s, u, c, f, d, h = [], p = typeof e;
                            for (e && "string" !== p && "function" !== p && e.length !== r || (e = [e]), u = 0, c = e.length; u < c; u++) for (f = 0, d = (s = e[u] && e[u].split && !e[u].match(/[\[\(:]/) ? e[u].split(",") : [e[u]]).length; f < d; f++) (l = n("string" == typeof s[f] ? s[f].trim() : s[f])) && l.length && (h = h.concat(l));
                            var g = a.selector[t];
                            ...
                            var r, a = [], o = e.aiDisplay, i = e.aiDisplayMaster, l = n.search, s = n.order,
                                u = n.page;
                            if ("ssp" == be(e)) return "removed" === l ? [] : _(0, i.length);
                            if ("current" == u) for (f = e._iDisplayStart, d = e.fnDisplayEnd(); f < d; f++) a.push(o[f]); else if ("current" == s || "applied" == s) {
                                if ("none" == l) a = i.slice(); else if ("applied" == l) a = o.slice(); else if ("removed" == l) {
                                    for (var c = {}, f = 0, d = o.length; f < d; f++) c[o[f]] = null;
                                    a = t.map(i, (function (t) {
                                        return c.hasOwnProperty(t) ? null : t
                                    }))
                                }
                            } else if ("index" == s || "original" == s) for (f = 0, d = e.aoData.length; f < d; f++) ("none" == l || -1 === (r = t.inArray(f, o)) && "removed" == l || r >= 0 && "applied" == l) && a.push(f);
                            return a
                        };
                        i("rows()", (function (e, n) {
                            e === r ? e = "" : t.isPlainObject(e) && (n = e, e = ""), n = Ce(n);
                            var a = this.iterator("table", (function (a) {
                                return function (e, n, a) {
                                    var o;
                                    return _e("row", n, (function (n) {
                                        var i = v(n), l = e.aoData;
                                        ...
                                        if (n.nodeName) {
                                            var s = n._DT_RowIndex, u = n._DT_CellIndex;
                            ...
                            for (var e = [], n = this.context, r = 0, a = n.length; r < a; r++) for (var i = 0, l = this[r].length; i < l; i++) {
                            ...
                            a && a.childRows && r.rows(t.map(a.childRows, (function (t) {
                                return t.replace(/:/g, "\\:")
                            }))).every((function () {
                        ...
                        var xe = s.util.throttle((function (t) {
                            ...
                            var e = new o(t), n = ".dt.DT_details", r = "draw" + n, a = "column-sizing" + n,
                                i = "destroy" + n, l = t.aoData;
                            e.off(r + " " + a + " " + i), y(l, "_details").length > 0 && (e.on(r, (function (n, r) {
                                ...
                                if (t === n) for (var o, i = B(n), s = 0, u = l.length; s < u; s++) (o = l[s])._details && o._details.children("td[colspan]").attr("colspan", i)
                            })), e.on(i, (function (n, r) {
                                if (t === r) for (var a = 0, o = l.length; a < o; a++) l[a]._details && Ae(e, a)
                            })))
                        }, Le = "row().child()";
                        i(Le, (function (e, n) {
                            var a = this.context;
                            return e === r ? a.length && this.length ? a[0].aoData[this[0]]._details : r : (!0 === e ? this.child.show() : !1 === e ? Ae(this) : a.length && this.length && function (e, n, r, a) {
                                var o = [], i = function (n, r) {
                                    if (Array.isArray(n) || n instanceof t) for (var a = 0, l = n.length; a < l; a++) i(n[a], r); else if (n.nodeName && "tr" === n.nodeName.toLowerCase()) o.push(n); else {
                        ...
                        var Re = /^([^:]+):(name|visIdx|visible)$/, Pe = function (t, e, n, r, a) {
                            for (var o = [], i = 0, l = a.length; i < l; i++) o.push(G(t, a[i], e));
                            return o
                        };
                        i("columns()", (function (e, n) {
                            ...
                            var a = this.iterator("table", (function (r) {
                                return function (e, n, r) {
                                    var a = e.aoColumns, o = y(a, "sName"), i = y(a, "nTh");
                            ...
                            var a = this, o = this.iterator("column", (function (n, a) {
                        ...
                        i("cells()", (function (e, n, a) {
                            if (t.isPlainObject(e) && (e.row === r ? (a = e, e = null) : (a = n, n = null)), t.isPlainObject(n) && (a = n, n = null), null === n || n === r) return this.iterator("table", (function (n) {
                                return function (e, n, a) {
                                    var o, i, l, s, u, c, f, d = e.aoData, h = Te(e, a), p = C(D(d, h, "anCells")),
                                        g = t(x([], p)), v = e.aoColumns.length;
                                    return _e("cell", n, (function (n) {
                                        var a = "function" == typeof n;
                                        if (null === n || n === r || a) {
                                            for (i = [], l = 0, s = h.length; l < s; l++) for (o = h[l], u = 0; u < v; u++) c = {
                                                row: o,
                                                column: u
                                            }, a ? (f = d[o], n(c, G(e, o, u), f.anCells ? f.anCells[u] : null) && i.push(c)) : i.push(c);
                                            return i
                                        }
                            ...
                            var o, i, l, s, u = a ? {page: a.page, order: a.order, search: a.search} : {},
                                c = this.columns(n, u), f = this.rows(e, u),
                                d = this.iterator("table", (function (t, e) {
                                    ...
                                    return n
                                }), 1), h = a && a.selected ? this.cells(d, a) : d;
                            ...
                            return t === r ? e.length && n.length ? G(e[0], n[0].row, n[0].column) : r : ($(e[0], n[0].row, n[0].column, t), rt(e[0], n[0].row, "data", n[0].column), this)
                            ...
                            if (!e) {
                                var n = this.context, a = n.length ? n[0].aaSortingFixed : r;
                            ...
                            for (var e, n, r = s.version.split("."), a = t.split("."), o = 0, i = a.length; o < i; o++) if ((e = parseInt(r[o], 10) || 0) !== (n = parseInt(a[o], 10) || 0)) return e > n;
                            return !0
                            ...
                            return n = n || !1, this.iterator("table", (function (r) {
                                var a, i = r.oClasses, l = r.nTable, u = r.nTBody, c = r.nTHead, f = r.nTFoot, d = t(l),
                                    h = t(u), p = t(r.nTableWrapper), g = t.map(r.aoData, (function (t) {
                                        return t.nTr
                                    }));
                                ...
                                var v = r.nTableWrapper.parentNode, b = n ? "remove" : "detach";
                                d[b](), p[b](), !n && v && (v.insertBefore(l, r.nTableReinsertBefore), d.css("width", r.sDestroyWidth).removeClass(i.sTable), (a = r.asDestroyStripes.length) && h.children().each((function (e) {
                            ...
                            var o = this.context[0], i = K(e)(o.oLanguage);
                            return i === r && (i = n), a !== r && t.isPlainObject(i) && (i = i[a] !== r ? i[a] : i._), i.replace("%d", a)
                        })), s.version = "1.12.1", s.settings = [], s.models = {}, s.models.oSearch = {
                            bCaseInsensitive: !0,
                            sSearch: "",
                            bRegex: !1,
                            bSmart: !0,
                            ...
                            fnDisplayEnd: function () {
                                var t = this._iDisplayLength, e = this._iDisplayStart, n = e + t,
                                    r = this.aiDisplay.length, a = this.oFeatures, o = a.bPaginate;
                        ...
                        function Ne(t, e) {
                            var n = [], r = je.numbers_length, a = Math.floor(r / 2);
                        ...
                        t.extend(je, {
                            ...
                            pageButton: {
                                _: function (e, a, o, i, l, s) {
                                    var u, c, f, d = e.oClasses, h = e.oLanguage.oPaginate,
                                        p = e.oLanguage.oAria.paginate || {}, g = 0, v = function (n, r) {
                                            var a, i, f, b, m = d.sPageButtonDisabled, S = function (t) {
                                                Wt(e, t.data.action, !0)
                                            };
                                            for (a = 0, i = r.length; a < i; a++) if (f = r[a], Array.isArray(f)) {
                                                var y = t("<" + (f.DT_el || "div") + "/>").appendTo(n);
                                                v(y, f)
                                            } else {
                                                switch (u = null, c = f, b = e.iTabIndex, f) {
                                                    case"ellipsis":
                                                        n.append('<span class="ellipsis">&#x2026;</span>');
                                                        break;
                                                    case"first":
                                                        u = h.sFirst, 0 === l && (b = -1, c += " " + m);
                                                        break;
                                                    case"previous":
                                                        u = h.sPrevious, 0 === l && (b = -1, c += " " + m);
                                                        break;
                                                    case"next":
                                                        u = h.sNext, 0 !== s && l !== s - 1 || (b = -1, c += " " + m);
                                                        break;
                                                    case"last":
                                                        u = h.sLast, 0 !== s && l !== s - 1 || (b = -1, c += " " + m);
                                                        break;
                                                    default:
                                                ...
                                                }).html(u).appendTo(n), {action: f}, S), g++)
                                            }
                                        };
                                    try {
                                    ...
                                    v(t(a).empty(), i), f !== r && t(a).find("[data-dt-idx=" + f + "]").trigger("focus")
                                }
                            }
                        ...
                        var He = function (t, e, n, r) {
                            return 0 === t || t && "-" !== t ? (e && (t = b(t, e)), t.replace && (n && (t = t.replace(n, "")), r && (t = t.replace(r, ""))), 1 * t) : -1 / 0
                        };
                        ...
                        function Ee(t, n, r) {
                            ...
                            if (e.moment) {
                                ...
                                if (!(a = n ? e.luxon.DateTime.fromFormat(t, n) : e.luxon.DateTime.fromISO(t)).isValid) return null;
                                a.setLocale(r)
                            } else n ? (We || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"), We = !0) : a = new Date(t);
                            return a
                        }
                        ...
                        var Ue = ",", Ve = ".";
                        if (Intl) try {
                            for (var Xe = (new Intl.NumberFormat).formatToParts(100000.1), Je = 0; Je < Xe.length; Je++) "group" === Xe[Je].type ? Ue = Xe[Je].value : "decimal" === Xe[Je].type && (Ve = Xe[Je].value)
                        } catch (t) {
                        }
                        ...
                        return s.datetime = function (t, e) {
                            ...
                            number: function (t, e, n, a, o) {
                                return null !== t && t !== r || (t = Ue), null !== e && e !== r || (e = Ve), {
                                    display: function (r) {
                                        if ("number" != typeof r && "string" != typeof r) return r;
                                        if ("" === r || null === r) return r;
                                        var i = r < 0 ? "-" : "", l = parseFloat(r);
                                        if (isNaN(l)) return Me(r);
                                        l = l.toFixed(n), r = Math.abs(l);
                                        var s = parseInt(r, 10), u = n ? e + (r - s).toFixed(n).substring(2) : "";
