...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")), function () {
    ...
    window.templateCustomizer && (t && t.addEventListener("click", function () {
        ...
        title: "Light mode",
        fallbackPlacements: ["bottom"]
    })), s("dark"))), "undefined" != typeof i18next && "undefined" != typeof i18NextHttpBackend && i18next.use(i18NextHttpBackend).init({
        lng: "en",
        debug: !1,
        fallbackLng: "en",
    ...
    if (a.length) {
        ...
        for (let e = 0; e < l.length; e++) l[e].addEventListener("click", function () {
            let e = this.getAttribute("data-language"), t = this.querySelector(".fi").getAttribute("class"),
                o = t.split(" ").filter(function (e) {
                    return 0 !== e.lastIndexOf("fs-", 0)
                });
            t = o.join(" ").trim() + " fs-3";
            for (var n of this.parentNode.children) n.classList.remove("selected");
            this.classList.add("selected"), a[0].querySelector(".dropdown-toggle .fi").className = t, i18next.changeLanguage(e, (e, t) => {
    ...
    var t, o, e, n = $(".search-toggler"), s = $(".search-input-wrapper"), a = $(".search-input"),
        l = $(".content-backdrop");
